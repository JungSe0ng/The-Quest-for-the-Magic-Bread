	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float2 temp_cast_2 = (_DetailTiling).xx;
				float2 texCoord49 = IN.ase_texcoord8.xy * temp_cast_2 + OffsetPOM11;
				float2 temp_output_47_0 = ddx( texCoord49 );
				float2 temp_output_48_0 = ddy( texCoord49 );
				...
				float3 unpack37 = UnpackNormalScale( tex2D( _DetailNormalMap, texCoord49, temp_output_47_0, temp_output_48_0 ), _DetailNormalMapScale1 );
				unpack37.z = lerp( 1, unpack37.z, saturate(_DetailNormalMapScale1) );
				
				float4 tex2DNode7 = tex2D( _MetallicGlossMap, customUVs14, temp_output_16_0, temp_output_15_0 );
				

				float3 BaseColor = ( _Color * ( tex2D( _MainTex, customUVs14, temp_output_16_0, temp_output_15_0 ) * tex2D( _DetailAlbedoMap, texCoord49, temp_output_47_0, temp_output_48_0 ) ) ).rgb;
				float3 Normal = BlendNormal( unpack5 , unpack37 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_15_0 = ddy( texCoord12 );
				float2 temp_cast_2 = (_DetailTiling).xx;
				float2 texCoord49 = IN.ase_texcoord4.xy * temp_cast_2 + OffsetPOM11;
				float2 temp_output_47_0 = ddx( texCoord49 );
				float2 temp_output_48_0 = ddy( texCoord49 );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 temp_output_15_0 = ddy( texCoord12 );
				float2 temp_cast_2 = (_DetailTiling).xx;
				float2 texCoord49 = IN.ase_texcoord2.xy * temp_cast_2 + OffsetPOM11;
				float2 temp_output_47_0 = ddx( texCoord49 );
				float2 temp_output_48_0 = ddy( texCoord49 );
		...
		Pass
		{
						 ...
						 )
			{
				...
				unpack5.z = lerp( 1, unpack5.z, saturate(_BumpScale) );
				float2 temp_cast_2 = (_DetailTiling).xx;
				float2 texCoord49 = IN.ase_texcoord5.xy * temp_cast_2 + OffsetPOM11;
				float2 temp_output_47_0 = ddx( texCoord49 );
				float2 temp_output_48_0 = ddy( texCoord49 );
				float3 unpack37 = UnpackNormalScale( tex2D( _DetailNormalMap, texCoord49, temp_output_47_0, temp_output_48_0 ), _DetailNormalMapScale1 );
				unpack37.z = lerp( 1, unpack37.z, saturate(_DetailNormalMapScale1) );
...
/*ASEBEGIN
Version=19603
Node;AmplifyShaderEditor.RangedFloatNode;52;-1072,16;Float;False;Property;_Tiling;Tiling;1;0;Create;True;0;0;0;False;0;False;1;0.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;10;-832.7482,125.0441;Inherit;True;Property;_ParallaxMap;Parallax Map;8;0;Create;True;0;0;0;False;0;False;None;eb3e237ea9444864299c696c46b1e1d7;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.Vector2Node;19;-776.6531,441.3777;Inherit;False;Property;_Curvature;Curvature;10;0;Create;True;0;0;0;False;0;False;0,0;0.2,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
Node;AmplifyShaderEditor.RangedFloatNode;18;-879.3531,324.3777;Float;False;Property;_Parallax;Parallax;9;0;Create;True;0;0;0;False;0;False;0.4247461;0.01;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;51;-992,704;Inherit;False;Property;_DetailTiling;DetailTiling;19;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;49;-768,608;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;4;-253.0746,-138.8561;Inherit;True;Property;_MainTex;Albedo;2;0;Create;False;0;0;0;False;0;False;-1;None;9553de79aa9bc734fb2a78503d1a8ef2;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;20;-243.6536,42.27751;Float;False;Property;_BumpScale;Normal Scale;4;0;Create;False;0;0;0;False;0;False;1;0.25;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;36;-239.5115,505.0964;Inherit;False;Property;_DetailNormalMapScale1;Normal Scale;18;0;Create;False;0;0;0;False;0;False;1;1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;40;-146.2426,-698.9814;Inherit;False;Property;_EmissionColor;Emission Color;14;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.SamplerNode;9;225.736,678.6254;Inherit;True;Property;_OcclusionMap;Occlusion Map;11;0;Create;True;0;0;0;False;0;False;-1;None;eb3e237ea9444864299c696c46b1e1d7;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;33;-250.0054,-324.2404;Inherit;True;Property;_DetailAlbedoMap;DetailAlbedoMap;16;0;Create;True;0;0;0;False;0;False;-1;None;b3410375c59e85547bd701a4cfbcc6a4;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;24;288,576;Float;False;Property;_OclusionStrength;Oclusion Strength;12;0;Create;True;0;0;0;False;0;False;1;0.3;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;5;-241.2481,115.9439;Inherit;True;Property;_BumpMap;Normal;3;0;Create;False;0;0;0;False;0;False;-1;None;054d24f51dd34704f82c7edd81e94a43;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ColorNode;32;88.22679,-247.8342;Inherit;False;Property;_Color;Color;0;0;Create;True;0;0;0;False;0;False;0.7830189,0.7830189,0.7830189,0;0.9056604,0.9056604,0.9056604,1;True;True;0;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.SamplerNode;37;-242.7746,311.6411;Inherit;True;Property;_DetailNormalMap;DetailNormal;17;0;Create;False;0;0;0;False;0;False;-1;None;2f84fc69b31844e4f8e991bb72c3e430;True;0;True;bump;Auto;True;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
Node;AmplifyShaderEditor.RangedFloatNode;22;48.07508,651.8056;Float;False;Property;_Glossiness;Glossiness;7;0;Create;True;0;0;0;False;0;False;0.5;0.5;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.PowerNode;42;525.8576,577.6187;Inherit;False;False;2;0;FLOAT;0;False;1;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;35;68.25706,464.9188;Float;False;Property;_Metallic;Metallic;6;0;Create;True;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;7;-277.6482,580.0438;Inherit;True;Property;_MetallicGlossMap;Metalness;5;0;Create;False;0;0;0;False;0;False;-1;None;eb3e237ea9444864299c696c46b1e1d7;True;0;False;white;Auto;False;Object;-1;Derivative;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;6;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT3;5
...
Node;AmplifyShaderEditor.ToggleSwitchNode;45;388.058,-281.6811;Inherit;False;Property;_Emission;Emission;13;0;Create;True;0;0;0;False;0;False;0;True;2;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
...
WireConnection;54;3;34;0
WireConnection;54;4;21;0
WireConnection;54;5;43;0
ASEEND*/
//CHKSM=E7726B47BCC8C7D53655559ABB58597F4C5CFD61